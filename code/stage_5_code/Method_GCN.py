...
class Method_GCN(method, nn.Module):
    ...
    def train(self, X, y):
        ...
        for epoch in range(self.max_epoch + 1):  # you can do an early stop if self.max_epoch is too much...
            # Randomization
            self.total_num = len(self.data['train_test_val']['idx_train']) + len(
                self.data['train_test_val']['idx_test'] + 1)
        ...
        # plot training convergence plot
    ...
    def run(self):
        ...
        if self.dataset_name == 'cora':
            ...
            print('citeseer')
            self.max_epoch = 1000
            # Citeseer has 3703 features per line and 6 classes
